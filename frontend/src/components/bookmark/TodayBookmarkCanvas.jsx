...
const STOPWORD_PATTERN =
  /(什么|为何|为什么|如何|看到|出现|不是|然而|但是|因为|这个|那个|一种|一场|一位|一个|今天|公司|专题|观察|研究|前沿|趋势|洞察|观点|管理|影响|解释|说明|分析|文章|内容|阅读|知识库|院长说|深度洞察|行业观察|学术前沿|专题广场|复旦管院|老师|同学|企业家|有了|这种|而是|如果|以及|我们|你们|他们|帮忙|正在|已经|简单|复杂|只是|不是|这样|那个|这个)/
