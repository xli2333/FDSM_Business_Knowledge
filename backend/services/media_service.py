    ...
    with connection_scope() as connection:
        ...
        connection.execute(
            ...
            (
                ...
                _apply_visibility_policy(kind, payload.get("visibility")),
...
def update_media_item(media_id: int, payload: dict) -> dict:
    ...
    with connection_scope() as connection:
        ...
        if "visibility" in payload and payload.get("visibility") is not None:
            current["visibility"] = _apply_visibility_policy(current["kind"], payload.get("visibility"))
        ...
        current["visibility"] = _apply_visibility_policy(current["kind"], current["visibility"])
