...
def main() -> None:
    ...
    editorial_export_removed = client.get(f"/api/editorial/articles/{editorial_id}/export?variant=web", headers=admin_headers)
    ...
    summary = {
        ...
        "editorial": {
            ...
            "export_removed": editorial_export_removed.status_code == 410,
